  ...
  //begin list of choices
    ...
    $('form').on('submit', function(e){
      ...
      $('.submit').on('click', function(){
        $('.resultContainer').html(`<h2>Forget who you were. Long has there been prophesy of your coming. Your destiny is thus, to be reborn as ${randomCharacter}. born to travel the world ${randomVehicle}. You owe all of your great power to ${randomObjectOfPower}. Unfortunately, your single greatest weakness is ${randomWeakness}. It will kill you instantly, so heed this warning! The fate of the world now rests solely on your shoulders. Good luck, ${randomCharacter}.</h2>`);
